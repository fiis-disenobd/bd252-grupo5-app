...
import { ContenedorMercancia } from "./src/shared/entities/contenedor-mercancia.entity";
import { Contenedor } from "./src/shared/entities/contenedor.entity";
...
const dataSource = new DataSource({
    ...
    port: 5432,
    username: "postgres",
    password: "password", // Default, might fail
    database: "bd252_grupo5",
