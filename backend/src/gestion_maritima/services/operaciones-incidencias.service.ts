        ...
        try {
            ...
            const result = await this.operacionMaritimaRepository.query(`
                INSERT INTO gestion_maritima.Inspeccion (
                    ...
                    (SELECT id_estado_inspeccion FROM shared.EstadoInspeccion WHERE nombre = 'Programada' LIMIT 1),
                    (SELECT id_prioridad FROM shared.Prioridad WHERE nombre = $4 LIMIT 1),
                    $5,
                    $6
