...
function SeleccionarBuqueContent() {
          ...
          <div className="flex justify-between items-center">
            <div>
              <h2 className="text-3xl font-bold text-gray-800 dark:text-white">
                Seleccionar Embarcación para Operación Portuaria
              </h2>
          ...
          <div className="bg-white dark:bg-slate-800 p-4 rounded-xl shadow-sm">
              ...
              {loading ? (
                <div className="px-6 py-8 text-center">
                  <div className="flex flex-col items-center gap-4">
                    <div className="animate-spin rounded-full h-8 w-8 border-b-2 border-[#0459af]"></div>
                    <p className="text-sm text-gray-600 dark:text-gray-400">
                      Cargando buques disponibles...
                    </p>
                  </div>
                </div>
              ) : error ? (
                  ...
                  <div className="flex flex-col items-center gap-4">
                    ...
                    <div>
                      ...
                      <p className="text-xs text-gray-500 dark:text-gray-400 mt-2">
                        Verifique la conexión a la base de datos o intente recargar la página
                      </p>
                    </div>
                    <button
            ...
            <div className="flex justify-end items-center mt-6 gap-4">
              <Link
                href={
                  baseQueryString
                    ? `/operaciones-portuarias/nueva?${baseQueryString}`
              ...
              <button
                ...
                onClick={() => {
                  if (selectedVessel) {
                    ...
                    router.push(
                      qs
                        ? `/operaciones-portuarias/nueva?${qs}`
                        : "/operaciones-portuarias/nueva"
                    );
                  }
                }}
...
export default function SeleccionarBuquePage() {
  return (
